      ...
      <div className={ styles.cartFooter }>
        <div style={{
          ...
          <div style={{ display: "flex", gap: '1rem' }}>
            <div>
              <span>Кіл-ть:</span> <span style={{ color: 'var(--text-green)', fontSize: 'var(--text-size)' }}>3</span>
            </div>
            <div>
              <span>Всього:</span> <span style={{ color: 'var(--text-green)', fontSize: 'var(--text-size)' }}>{currencyFormat.format(400)}</span>
            </div>
          </div>
        </div>
        <div style={{
